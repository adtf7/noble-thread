...
router.post('/categoryedit/:id', adminauth, categoryControllers.seteditcategory);
router.delete("/category/:id", adminauth, categoryControllers.deleteCategory);
router.post('/add-category-offer/:categoryId',adminauth,categoryControllers.addCategoryOffer)
router.delete('/remove-category-offer/:categoryId',adminauth,categoryControllers.removeoffer)

router.get('/productadd', adminauth, productControllers.productaddpage);
router.post('/productadd', adminauth, upload.array('productImage', 3), productControllers.addProduct);
...
router.post('/editproduct/:id', adminauth, upload.array('productImage', 3), (req, res) => {
...
router.delete("/remove-product-offer/:productId",adminauth,productControllers.deleteoffer);
...
router.post("/handle-return-request",adminauth,orderControllers.handleReturnRequest
);
router.post("/singlehandle-return-request",adminauth,orderControllers.singlehandleReturnRequest)
router.post("/update-item-status",adminauth,orderControllers.updateItemStatus)
...
router.get("/sales-report/pdf",
  adminauth,
  salesreportControllers.salespdf
);
router.get(
